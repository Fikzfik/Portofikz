...
const projects = [
  {
    ...
    description: "A high-performance Neo-Brutalist platform for managing competitive tournaments and campus events with real-time orchestration.",
  ...
  },
  {
    ...
    description: "Smart mobile application integrating generative AI for automated expense tracking via receipt scanning and voice commands.",
  ...
  },
  {
    ...
    description: "Premium cooking inspiration platform featuring real-time recipe discovery, interactive ingredient checklists, and animated motion UI.",
  ...
  },
  {
    ...
    description: "Full-featured camping gear rental web app built with Laravel and Midtrans payment gateway, with real-time stock and penalty tracking.",
  ...
  },
  {
    ...
    description: "High-performance SaaS Enterprise Resource Management platform built with Go for isolated inventory, logs, and billing cycles.",
