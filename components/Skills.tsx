...
const skillGroups: SkillGroup[] = [
  {
    ...
    skills: [
      { name: "Next.js", percent: 95, icon: "/icon/nextjs.svg" },
      { name: "React", percent: 92, icon: "/icon/react.svg" },
      { name: "TypeScript", percent: 88, icon: "/icon/typescript.svg" },
      { name: "JavaScript", percent: 95, icon: "/icon/js.svg" },
      { name: "HTML", percent: 98, icon: "/icon/html.svg" },
      { name: "CSS", percent: 95, icon: "/icon/css.svg" },
      { name: "Tailwind", percent: 90, icon: "/icon/tailwind.svg" },
      { name: "Sass", percent: 78, icon: "/icon/sass.svg" },
      { name: "Bootstrap", percent: 80, icon: "/icon/bootstrap.svg" },
      { name: "Three.js", percent: 65, icon: "/icon/threejs.svg" },
      { name: "React Query", percent: 75, icon: "/icon/react-query.svg" },
      { name: "Vite", percent: 82, icon: "/icon/vite.svg" },
    ],
  },
  {
    id: "backend",
    ...
    skills: [
      { name: "Node.js", percent: 85, icon: "/icon/nodejs.svg" },
      { name: "Express", percent: 80, icon: "/icon/express.svg" },
      { name: "PHP", percent: 72, icon: "/icon/php.svg" },
      { name: "Laravel", percent: 68, icon: "/icon/laravel.svg" },
      { name: "Go", percent: 55, icon: "/icon/go.svg" },
      { name: "Java", percent: 60, icon: "/icon/java.svg" },
      { name: "Python", percent: 65, icon: "/icon/python.svg" },
      { name: "MySQL", percent: 78, icon: "/icon/mysql.svg" },
      { name: "MongoDB", percent: 70, icon: "/icon/mongodb.svg" },
    ],
  },
  {
    id: "tools",
    ...
    skills: [
      ...
      { name: "Blender", percent: 60, icon: "/icon/blender.svg" },
      { name: "Spline", percent: 70, icon: "/icon/spline.svg" },
      { name: "Git", percent: 88, icon: "/icon/git.svg" },
      { name: "GitHub", percent: 90, icon: "/icon/github.svg" },
      { name: "VS Code", percent: 95, icon: "/icon/vscode.svg" },
      { name: "Webpack", percent: 65, icon: "/icon/webpack.svg" },
      { name: "NPM", percent: 85, icon: "/icon/npm.svg" },
      { name: "Yarn", percent: 80, icon: "/icon/yarn.svg" },
    ],
  },
];
